const baseExtensions: Extension[] = [
  {
    ...
    importPath: '@astermesh/pglite/vector',
    importName: 'vector',
    core: true,
    size: 43953,
  },
  {
    ...
    tags: ['pglite plugin'],
    importPath: '@astermesh/pglite/live',
    importName: 'live',
    core: true,
    size: 21766,
  },
  {
    ...
    importPath: '@astermesh/pglite/contrib/amcheck',
    importName: 'amcheck',
    core: true,
    size: 18815,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/auto_explain',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/bloom',
    importName: 'bloom',
    core: true,
    size: 6197,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/btree_gin',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/btree_gist',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/citext',
    importName: 'citext',
    core: true,
    size: 4983,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/cube',
    importName: 'cube',
    core: true,
    size: 15104,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/earthdistance',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/fuzzystrmatch',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/hstore',
    importName: 'hstore',
    core: true,
    size: 21380,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/intarray',
    importName: 'intarray',
    core: true,
    size: 14712,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/dict_xsyn',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/pageinspect',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/dict_int',
    importName: 'dict_int',
    core: true,
    size: 1361,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/unaccent',
    importName: 'unaccent',
    core: true,
    size: 9323,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/pg_surgery',
  ...
  },
  {
    ...
    tags: ['postgres extension'],
    importPath: '@astermesh/pglite/pgtap',
    importName: 'pgtap',
    size: 239428,
  },
  {
    ...
    tags: ['postgres extension'],
    importPath: '@astermesh/pglite/pg_uuidv7',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/pg_walinspect',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/pg_visibility',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/pg_freespacemap',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/pg_buffercache',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/file_fdw',
    importName: 'file_fdw',
    core: true,
    size: 4467,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/isn',
    importName: 'isn',
    core: true,
    size: 31417,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/lo',
    importName: 'lo',
    core: true,
    size: 1822,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/ltree',
    importName: 'ltree',
    core: true,
    size: 19553,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/pg_trgm',
    importName: 'pg_trgm',
    core: true,
    size: 16208,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/seg',
    importName: 'seg',
    core: true,
    size: 10426,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/tablefunc',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/tcn',
    importName: 'tcn',
    core: true,
    size: 1914,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/tsm_system_rows',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/tsm_system_time',
  ...
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/uuid_ossp',
  ...
  },
  {
    ...
    tags: ['postgres extension'],
    importPath: '@astermesh/pglite/pg_ivm',
    importName: 'pg_ivm',
    size: 24865,
  },
  {
    ...
    tags: ['postgres extension', 'postgres/contrib'],
    importPath: '@astermesh/pglite/contrib/pgcrypto',
    importName: 'pgcrypto',
    core: true,
    size: 1148162,
  },
  {
    ...
    tags: ['postgres extension'],
    importPath: '@astermesh/pglite/pg_hashids',
